...
import com.example.booklette.databinding.ManageshopVoucherviewDialogBinding
...
class ManageShopVoucherViewDialog(discountDetail: HashMap<String, Comparable<*>?>): Sheet() {
    private lateinit var binding: ManageshopVoucherviewDialogBinding
    ...
    override fun onCreateLayoutView(): View {
        return ManageshopVoucherviewDialogBinding.inflate(LayoutInflater.from(activity))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.minimumOrderET.setText(discountDetail["minimumOrder"].toString())
...
//        Hide the toolbar of the sheet, the title and the icon
    ...
    fun build(ctx: Context, width: Int? = null, func: ManageShopVoucherViewDialog.() -> Unit): ManageShopVoucherViewDialog {
    ...
    /** Build and show [ManageShopVoucherViewDialog] directly. */
    fun show(ctx: Context, width: Int? = null, func: ManageShopVoucherViewDialog.() -> Unit): ManageShopVoucherViewDialog {
        this.windowContext = ctx
        this.width = width
        this.func()
        this.show()
