...
class ProfileSettingChangePasswordDialogDialog(
...
//        Hide the toolbar of the sheet, the title and the icon
    ...
    fun build(ctx: Context, width: Int? = null, func: ProfileSettingChangePasswordDialogDialog.() -> Unit): ProfileSettingChangePasswordDialogDialog {
    ...
    /** Build and show [ProfileSettingChangePasswordDialogDialog] directly. */
    fun show(ctx: Context, width: Int? = null, func: ProfileSettingChangePasswordDialogDialog.() -> Unit): ProfileSettingChangePasswordDialogDialog {
        this.windowContext = ctx
        this.width = width
        this.func()
        this.show()
